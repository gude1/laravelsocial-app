...
class PostCommentReplyController extends Controller
{
    ...
    public function index()
    {
        ...
        if (
            is_null($owner_comment) || empty($owner_comment) || $owner_comment->profile->user->deleted == true || $owner_comment->profile->user->suspended == true || $owner_comment->profile->user->approved != true || ($owner_comment->hidden == true &&
    ...
    public function store(Request $req)
    {
        ...
        if (
            is_null($originid) || empty($originid) || is_null($reply_text) || empty($reply_text) ||
    ...
    public function show(Request $req)
    {
        ...
        if (
            is_null($reply) || empty($reply) || $reply->profile->user->deleted == true ||
    ...
    public function handleLikeAction(Request $req)
    {
        ...
        if (
            is_null($tolikereply) || empty($tolikereply) || $tolikereply->profile->user->deleted == true || $tolikereply->profile->user->approved != true || $tolikereply->profile->user->suspended == true || ($tolikereply->hidden == true &&
